// resend-notify.js — AssessKit LP
// Required env vars: RESEND_API_KEY, RESEND_FROM_EMAIL, CONTACT_EMAIL
// RESEND_SEGMENT_ID defaults to the AssessKit waitlist segment if not overridden.

const PRODUCT_SEGMENT_ID = '35b4b791-2d7b-47a7-9232-5c671753f580'; // Waitlist-AssessKit
...
module.exports = async function handler(req, res) {
  ...
  const productName = product || 'AssessKit';
